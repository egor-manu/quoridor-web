...
A polished, touch-first browser version of Quoridor for playing against a local AI. It supports 7×7, 9×9, and 11×11 boards, four difficulty modes, undo, local preferences, and offline play. No account, backend, analytics, or network connection is needed after the first load.
